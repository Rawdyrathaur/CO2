...
const MetricCard = ({ icon: Icon, label, value, unit, decimals }) => (
  <div className="group bg-gradient-to-br from-gray-900 to-gray-800 rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border border-gray-800/50 hover:border-accent/30 transition-all">
    <div className="flex items-center justify-between mb-3 sm:mb-4">
      <div className="p-2 sm:p-2.5 md:p-3 bg-gray-800/50 rounded-lg">
        <Icon className="text-accent" size={16} />
      </div>
    </div>
    <div className="text-2xl sm:text-2xl md:text-3xl font-black text-white mb-1">
    ...
    <p className="text-[10px] sm:text-xs text-gray-500 font-semibold uppercase tracking-wide">{label}</p>
  </div>
);
